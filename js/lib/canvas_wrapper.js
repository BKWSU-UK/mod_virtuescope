...
cwPrototype.getRotation = function() {
    return this.rotation;
};

cwPrototype.setRotation = function(aRot) {
    this.rotation += aRot;
...
cwPrototype.rotate = function (aRot) {
    ...
    setM(this, matrixMultiply(m1, this.m_));
    this.setRotation(aRot)
};

cwPrototype.resetRotation = function() {
    this.rotation = 0;
};
...
cwPrototype.drawImage = function(img,x,y,width,height) {
    this.canvas.drawImage(img,x,y,width,height)
};
//cwPrototype.drawImage = function(img,sx,sy,swidth,sheight,x,y,width,height) {
